...
<!-- Begin Footer Area -->
            <div style="background-color:#FED700"class="footer">
                                ...
                                <div class="col-lg-4">
                                    <div class="footer-block">
                                        ...
                                        <ul class="social-link">
                                            ...
                                            <li class="facebook">
                                                <a href="<?php echo $ayarCek['facebook']?>" data-toggle="tooltip" target="_blank" title="Facebook Hesabımızı Takip Edin">
                                                    <i class="fa fa-facebook"></i>
                                                </a>
                                            </li>
                                            <li class="youtube">
                                                <a href="<?php echo $ayarCek['youtube']?>" data-toggle="tooltip" target="_blank" title="Youtube Hesabımız Takip Edin">
